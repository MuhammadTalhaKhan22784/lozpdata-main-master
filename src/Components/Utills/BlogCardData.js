                    ...
                    <div className="blog-card card" style={{ width: "22rem" }}>
                        ...
                        <div className="blog-card-body card-body">
                            ...
                            <div className="blg-icon-1 pt-2">
                                <img alt="img" src="https://digiryte.com/blog/assets/calender-59fcb70f976b9bbc8faf649512dccba9147826687ca6a0f167b6fb8174fb2a1b.png" />
                                <span className="ms-2 fs-6">April 07, 2020 09:27</span>
                            </div>
                            <div className="blg-icon-2 mt-3">
                                <div>
                                    <img alt="img" src="https://digiryte.com/blog/assets/icon2-8f21fc2e212c193d3ec3506a07a13f1dd521757b107c867ae2d87fb1558f9005.png" />
                                    <span className="ms-2 fs-6">5 min Read</span>
                                </div>
                                <div className="pe-5">
                                    <img alt="img" src="https://digiryte.com/blog/assets/icon3-7a4d6c97f960c1cb8f21bfe572f8f3bed8ab07ce70bc33f828ec80f5079379b6.png" />
